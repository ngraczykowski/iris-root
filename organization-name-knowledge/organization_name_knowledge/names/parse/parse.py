...
from organization_name_knowledge.names.parse.parse_parentheses import (
...
def _detect_name_parts(name: str) -> Dict[str, TokensSequence]:
    ...
    other, country_from_other = extract_countries(other)
    ...
    return {
        ...
        "legal": information[3],
        "other": information[4],
        "country_from_other": country_from_other,
    }
...
def parse_name(name: str) -> NameInformation:
    ...
    return NameInformation(
        ...
        countries=parentheses_information["countries"] + base_information["country_from_other"],
