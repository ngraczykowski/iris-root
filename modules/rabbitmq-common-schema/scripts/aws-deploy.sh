...
export CHART_NAME=sear-rabbitmq-common-schema-initializr-app
export IMAGE_REPO=$ECR_REPO/$CHART_NAME
export RABBITMQ_ADDRESS=sierra-uat-rmq-nlb-5b816360e878373c.elb.eu-central-1.amazonaws.com
