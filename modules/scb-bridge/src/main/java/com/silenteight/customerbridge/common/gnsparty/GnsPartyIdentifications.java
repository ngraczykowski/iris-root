...
import static com.silenteight.customerbridge.common.gnsparty.IdentificationPattern.compileAll;
...
public class GnsPartyIdentifications {
  ...
  private static final Set<Pattern> NATIONAL_ID_PATTERNS = compileAll(
  ...
  private static final Set<Pattern> PASSPORT_PATTERNS = compileAll(
