...
public class GnsParty {
  ...
  public Set<String> getAlternateNames() {
    return getCollectionAsSet(GnsPartyCommonFields.ALTERNATE_NAMES);
  }
  ...
  public void addPassportNumbers(List<String> values) {
    add(GnsPartyCommonFields.PASSPORT_NUMBERS, values);
  }

  public List<String> getPassportNumbers() {
    return getCollectionAsList(GnsPartyCommonFields.PASSPORT_NUMBERS);
  }
  ...
  public void addNationalIds(List<String> values) {
    add(GnsPartyCommonFields.NATIONAL_IDS, values);
  }

  public List<String> getNationalIds() {
    return getCollectionAsList(GnsPartyCommonFields.NATIONAL_IDS);
  }
}
