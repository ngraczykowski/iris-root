...
import static com.silenteight.iris.bridge.scb.ingest.adapter.incomming.gnsrt.model.GnsRtAlertStatus.FALSE_MATCH;
import static com.silenteight.iris.bridge.scb.ingest.adapter.incomming.gnsrt.model.GnsRtAlertStatus.MATCH;
import static com.silenteight.iris.bridge.scb.ingest.adapter.incomming.gnsrt.model.GnsRtAlertStatus.POTENTIAL_MATCH;
...
class GnsRtRecommendationRequestValidationTest {
  ...
  class AllPotentialMatchesHasValidAlertIdTest {
    ...
    void invalidAlertIdTest() {
      var request = request(List.of(alert("INVALID_ALERT_ID")));
    ...
    void validAlertIdTest() {
      var request = request(List.of(alert("US_PERD_DUDL!8A1DFAFE-EA1041B0-9F1426E6-DBD75121")));
