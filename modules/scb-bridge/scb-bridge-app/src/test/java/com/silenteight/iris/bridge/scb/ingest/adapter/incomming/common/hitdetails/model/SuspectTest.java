...
class SuspectTest {
  ...
  void givenEmptyAndFilledSuspect_merge_shouldReturnSuspectWithValidValues() {
    ...
    Assertions.assertThat(actual.getOtherTags()).containsOnly(lessImportantTag);
  }
  ...
  void twoSuspectsAndOneWithMoreImportantTag_merge_otherTagsContainsOnlyLessImportantTag() {
    ...
    Assertions.assertThat(actualMergedFromFirst.getOtherTags()).containsOnly(lessImportantTag);
    Assertions.assertThat(actualMergedFromSecond.getOtherTags()).containsOnly(lessImportantTag);
  }
  ...
  void twoSuspectsWithDifferentImportanceTags_merge_returnsSubjectWithCorrectValues() {
    ...
    Assertions.assertThat(actualMergedFromSecond.getOtherTags())
