...
import com.silenteight.iris.bridge.scb.outputrecommendation.domain.Fixtures
...
class RecommendationSenderSpec extends Specification {
  ...
  def gnsRtRecommendationService = Mock(com
      .silenteight
      .iris.bridge.scb.ingest.adapter.incomming.gnsrt.recommendation.GnsRtRecommendationService)
