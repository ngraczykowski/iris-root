...
class RecommendationsProcessorSpec extends Specification {
  ...
  def payloadConverter = Mock(com.silenteight.iris.bridge.scb.ingest.domain.payload.PayloadConverter)
  def recommendationsMapper = new RecommendationsMapper(payloadConverter)
  def recommendationApiClient = Mock(com
      .silenteight.iris.bridge.scb.outputrecommendation.domain.port.outgoing.RecommendationApiClient)
  def recommendationPublisher = Mock(com
      .silenteight.iris.bridge.scb.outputrecommendation.domain.port.outgoing.RecommendationPublisher)
  def recommendationDeliveredEventPublisher = Mock(com
      .silenteight
      .iris
      .bridge.scb.outputrecommendation.domain.port.outgoing.RecommendationDeliveredEventPublisher)
