...
class RecordToAlertMapperSpec extends Specification {
  ...
  def 'should build suspect context'() {
    given:
    def decisions = new DecisionsCollection([com
                                                 .silenteight
                                                 .iris
                                                 .bridge
                                                 .scb
                                                 ...
                                                 .adapter
                                                 .incomming
                                                 .common.model.decision.Decision.builder().build()])
  ...
  def assertDamagedAlert(com.silenteight.iris.bridge.scb.ingest.adapter.incomming.common.model.alert.Alert result) {
    result.state == com
        .silenteight.iris.bridge.scb.ingest.adapter.incomming.common.model.alert.Alert.State.STATE_DAMAGED
    result.decisionGroup == 'EN_BTCH_ALLOW'
    result.securityGroup == 'EN'
    result.decisions.isEmpty()
    result.flags == Flag.NONE.value
    result.generatedAt
    result.receivedAt
    result.alertedParty
    result.details
  ...
  def createSuspect() {
    new com.silenteight.iris.bridge.scb.ingest.adapter.incomming.common.hitdetails.model.Suspect(ofacId: someOfacId, batchId: EMPTY_VALUE, index: 1)
  }
  ...
  def createDecision(String authorId) {
    com.silenteight.iris.bridge.scb.ingest.adapter.incomming.common.model.decision.Decision.builder()
        ...
        .solution(com
            .silenteight
            .iris
            .bridge.scb.ingest.adapter.incomming.common.model.decision.Decision.AnalystSolution.ANALYST_FALSE_POSITIVE)
        .build()
  }
