...
package com.silenteight.iris.bridge.scb.ingest.adapter.incomming.gnsrt.request
...
class PotentialMatchAlertIdValidatorSpec extends Specification {
  ...
  def objectUnderTest = new com.silenteight.iris.bridge.scb.ingest.adapter.incomming.gnsrt.model.request.PotentialMatchAlertIdValidator()
  ...
  def createAlert(String alertId, GnsRtAlertStatus status) {
    new com.silenteight.iris.bridge.scb.ingest.adapter.incomming.gnsrt.model.request.GnsRtAlert(alertId: alertId, alertStatus: status)
  }
}
