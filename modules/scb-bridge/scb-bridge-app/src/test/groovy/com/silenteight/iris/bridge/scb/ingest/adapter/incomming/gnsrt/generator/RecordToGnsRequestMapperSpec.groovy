...
class RecordToGnsRequestMapperSpec extends Specification {
  ...
  def 'should throw illegal state exception when hit details cannot be parsed'() {
    ...
    def alertDto = AlertDto.builder()
        ...
        .suspects([new com.silenteight.iris.bridge.scb.ingest.adapter.incomming.common.hitdetails.model.Suspect(ofacId: '1')])
        .build()
  ...
  def 'should throw exception when filtered date is empty or invalid, #filteredDate'() {
    ...
    def alertDto = AlertDto.builder()
        ...
        .systemId(alertRecord.systemId)
        .suspects([new com.silenteight.iris.bridge.scb.ingest.adapter.incomming.common.hitdetails.model.Suspect(ofacId: 'AS00115135')])
        .build()
    def objectUnderTest = RecordToGnsRequestMapper.builder()
        .alertedParty(GnsParty.empty())
        .record(alertRecord)
  ...
  def 'should map to gnsRt request'() {
    ...
    def suspect1 = new com.silenteight.iris.bridge.scb.ingest.adapter.incomming.common.hitdetails.model.Suspect(ofacId: 'AS00115135')
    def suspect2 = new com.silenteight.iris.bridge.scb.ingest.adapter.incomming.common.hitdetails.model.Suspect(ofacId: 'AS03727093')
    def suspect3 = new com.silenteight.iris.bridge.scb.ingest.adapter.incomming.common.hitdetails.model.Suspect(ofacId: 'AM00001443')
