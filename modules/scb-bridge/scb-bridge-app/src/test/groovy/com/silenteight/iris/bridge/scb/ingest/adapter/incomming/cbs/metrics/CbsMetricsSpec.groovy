...
import com.silenteight.iris.bridge.scb.ingest.adapter.incomming.cbs.metrics.CbsMetrics.MetricNames
...
class CbsMetricsSpec extends Specification {
  ...
  private void ackCall(String statusCode, boolean watchlistLevel) {
    def event = com
        .silenteight.iris.bridge.scb.ingest.adapter.incomming.cbs.gateway.event.AckCalledEvent
        .builder()
  ...
  private void recomCall(String statusCode) {
    underTest.cbsEventListener(com
        .silenteight
        .iris
        .bridge
        .scb
        .ingest
        .adapter.incomming.cbs.gateway.event.RecomCalledEvent.builder().statusCode(statusCode).build())
  }
  ...
  private void callFailed(String functionType) {
    underTest.cbsEventListener(com
        ...
        .ingest
        .adapter
        .incomming.cbs.gateway.event.CbsCallFailedEvent.builder().functionType(functionType).build())
  }
