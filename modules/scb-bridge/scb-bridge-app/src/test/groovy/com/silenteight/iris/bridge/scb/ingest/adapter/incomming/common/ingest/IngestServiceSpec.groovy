...
import com.silenteight.iris.bridge.scb.ingest.domain.AlertRegistrationFacade
import com.silenteight.iris.bridge.scb.reports.domain.port.outgoing.ReportsSenderService

import spock.lang.Specification

import static Fixtures.alerts
import static Fixtures.recommendation
import static com.silenteight.iris.bridge.scb.ingest.domain.Fixtures.registrationResponse
...
import static com.silenteight.iris.bridge.scb.ingest.domain.model.RegistrationBatchContext.LEARNING_CONTEXT

class IngestServiceSpec extends Specification {

  def scbRecommendationService = Mock(com
      .silenteight
