...
import com.silenteight.iris.bridge.scb.ingest.adapter.incomming.common.gender.Gender
...
class GnsRtAlertedPartyCreatorSpec extends Specification {
  ...
  def data = new com.silenteight.iris.bridge.scb.ingest.adapter.incomming.gnsrt.model.request.ScreenableData(
      amlCountry: 'SG',
      clientType: 'I',
  ...
  def 'should create correct gender based on name'() {
    given:
    def genderCaseData = new com.silenteight.iris.bridge.scb.ingest.adapter.incomming.gnsrt.model.request.ScreenableData(
        customerIdentificationNo: 'customerIdentificationNo',
        clientType: 'I',
