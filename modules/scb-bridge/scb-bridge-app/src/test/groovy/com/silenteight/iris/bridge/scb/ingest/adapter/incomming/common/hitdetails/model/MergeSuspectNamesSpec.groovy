...
import static Tag.NAME
import static Tag.SEARCH_CODE
...
class MergeSuspectNamesSpec extends Specification {
  ...
  private static Set<com.silenteight.iris.bridge.scb.ingest.adapter.incomming.common.WlName> wlNames(wlNameDef) {
    def wlNames = new HashSet();
    wlNameDef.each {wlNames.add(wlNameOf(it))}
    return wlNames;
  }

  private static com.silenteight.iris.bridge.scb.ingest.adapter.incomming.common.WlName wlNameOf(wlNameDef) {
    return new com.silenteight.iris.bridge.scb.ingest.adapter.incomming.common.WlName(wlNameDef[0], com
        .silenteight
        .iris
        .bridge
        .scb
        ...
        .incomming
        .common
        .WlNameType.valueOf(wlNameDef[1]))
  }
