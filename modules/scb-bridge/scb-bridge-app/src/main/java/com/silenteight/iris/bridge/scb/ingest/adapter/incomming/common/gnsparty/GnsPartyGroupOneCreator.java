...
class GnsPartyGroupOneCreator extends AbstractGnsPartyCreator {
  ...
  protected GnsParty createAdditionalFields(GnsParty result) {
    result.copyField("accountName", GnsPartyCommonFields.NAME);
    ...
    result.createList(
        GnsPartyCommonFields.PASSPORT_NUMBERS, singletonList(GnsPartyCommonFields.PASSPORT_NUMBERS));

    result.createList(GnsPartyCommonFields.NATIONAL_IDS, singletonList(NATIONAL_IDENTITY_NUMBER_FIELD));
