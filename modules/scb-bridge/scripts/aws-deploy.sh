...
export CHART_NAME=scb-bridge-app
...
skopeo copy docker://docker.repo.silenteight.com/scb-bridge/$CHART_NAME:$INSTALLER_VERSION docker://$IMAGE_REPO:$INSTALLER_VERSION
skopeo copy docker://docker.repo.silenteight.com/scb-bridge/$CHART_NAME:$INSTALLER_VERSION docker://$IMAGE_REPO:latest