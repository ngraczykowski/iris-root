...
@Component
class OutputRecommendationAmqpErrorHandler implements RabbitListenerErrorHandler {

  private final AmqpOutputRecommendationProperties amqpOutputRecommendationProperties;
  ...
  public Object handleError(
    ...
    getMessageDeathCount(amqpMessage).ifPresentOrElse(
        value -> {
          var numberOfRetries = amqpOutputRecommendationProperties.numberOfRetriesDeadMessages();
