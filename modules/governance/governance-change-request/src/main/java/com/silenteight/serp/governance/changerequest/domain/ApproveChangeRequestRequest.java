...
@Value
@Builder
public class ApproveChangeRequestRequest implements AuditableRequest {

  public static final String PRE_AUDIT_TYPE = "ApproveChangeRequestRequested";
  public static final String POST_AUDIT_TYPE = "ChangeRequestApproved";
