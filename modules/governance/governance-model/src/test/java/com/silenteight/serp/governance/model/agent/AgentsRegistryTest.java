...
import static com.silenteight.serp.governance.model.agent.config.AgentConfigFixture.DATE_AGENT_CONFIG;
import static com.silenteight.serp.governance.model.agent.config.AgentConfigFixture.NAME_AGENT_CONFIG;
import static com.silenteight.serp.governance.model.agent.config.AgentConfigFixture.NAME_AGENT_CONFIG_NAME;
import static com.silenteight.serp.governance.model.agent.details.AgentDetailsFixture.DATE_AGENT_DETAIL;
import static com.silenteight.serp.governance.model.agent.details.AgentDetailsFixture.NAME_AGENT_DETAIL;
...
class AgentsRegistryTest {
  ...
  void shouldReturnSpecificAgent() {
    when(agentDiscovery.getAgentConfigs())
        .thenReturn(of(NAME_AGENT_CONFIG));
    when(agentDetailsClient.getAgentDetailsForAgentConfig(NAME_AGENT_CONFIG))
        .thenReturn(NAME_AGENT_DETAIL);
