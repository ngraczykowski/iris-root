...
public final class ModelFixtures {
  ...
  public static final String POLICY = "policies/" + POLICY_ID.toString();
  public static final String DEFAULT_MODEL_NAME = "solvingModels/default";
  public static final String MODEL_RESOURCE_NAME = "solvingModels/" + MODEL_ID.toString();
  ...
  public static final OffsetDateTime UPDATED_AT =
      OffsetDateTime.of(2021, 04, 11, 8, 10, 15, 0, UTC);
