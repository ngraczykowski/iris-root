...
public class AgentConfigFixture {
  ...
  public static final AgentConfigDto NAME_AGENT_CONFIG = new AgentConfigDto(NAME_AGENT_CONFIG_NAME);
  public static final AgentConfigDto DATE_AGENT_CONFIG = new AgentConfigDto(DATE_AGENT_CONFIG_NAME);
}
