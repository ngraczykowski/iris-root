...
class FeatureVectorQueryTest {
  ...
  private final AnalyticsFeatureVectorConfiguration configuration =
      new AnalyticsFeatureVectorConfiguration();

  private final FeatureVectorService service =
      configuration.analyticsFeatureVectorService(repository);

  private final FeatureVectorQuery underTest =
      configuration.analyticsFeatureVectorQuery(repository);
