...
@Builder
@JsonPropertyOrder({
    "FKCO_ID", "FKCO_V_SYSTEM_ID", "FKCO_V_FORMAT", "FKCO_V_TYPE", "FKCO_V_TRANSACTION_REF",
    "FKCO_V_RELATED_REF", "FKCO_V_SENS", "FKCO_V_BUSINESS_UNIT", "FKCO_V_APPLICATION",
    "FKCO_V_CURRENCY", "FKCO_F_AMOUNT", "FKCO_V_CONTENT", "FKCO_B_HIGHLIGHT_ALL",
    "FKCO_V_VALUE_DATE", "FKCO_UNIT", "FKCO_I_MSG_FML_PRIORITY", "FKCO_I_MSG_FML_CONFIDENTIALITY",
    "FKCO_D_APP_DEADLINE", "FKCO_I_APP_PRIORITY", "FKCO_I_NORMAMOUNT", "FKCO_V_MESSAGEID",
    "FKCO_V_COPY_SERVICE", "FKCO_V_ACTION_COMMENT", "FKCO_ACTION_DATE", "FKCO_D_FILTERED_DATETIME",
    "FKCO_D_ACTION_DATETIME", "FKCO_OPERATOR", "FKCO_STATUS", "FKCO_I_TOTAL_ACTION", "FKCO_UNIT_1",
    "FKCO_MESSAGES", "FKCO_B_HIGHLIGHT_HIT", "FKCO_V_NAME_MATCHED_TEXT",
    "FKCO_V_ADDRESS_MATCHED_TEXT", "FKCO_V_CITY_MATCHED_TEXT", "FKCO_V_STATE_MATCHED_TEXT",
    "FKCO_V_COUNTRY_MATCHED_TEXT", "FKCO_V_LIST_MATCHED_NAME", "FKCO_V_FML_TYPE",
    "FKCO_I_FML_PRIORITY", "FKCO_I_FML_CONFIDENTIALITY", "FKCO_V_HIT_MATCH_LEVEL",
    "FKCO_V_HIT_TYPE", "FKCO_I_NONBLOCKING", "FKCO_I_BLOCKING", "FKCO_LISTED_RECORD",
    "FKCO_FILTERED_DATE", "FKCO_D_FILTERED_DATETIME_1", "FKCO_V_MATCHED_TAG",
    "FKCO_V_MATCHED_TAG_CONTENT", "FKCO_I_SEQUENCE", "FKCO_UNIT_2", "FKCO_V_LIST_FMM_ID",
    "FKCO_V_LIST_OFFICIAL_REF", "FKCO_V_LIST_TYPE", "FKCO_V_LIST_ORIGIN", "FKCO_V_LIST_DESIGNATION",
    "FKCO_V_LIST_PEP", "FKCO_V_LIST_FEP", "FKCO_V_LIST_NAME", "FKCO_V_LIST_CITY",
    "FKCO_V_LIST_STATE", "FKCO_V_LIST_COUNTRY", "FKCO_V_LIST_USERDATA1", "FKCO_V_LIST_USERDATA2",
    "FKCO_V_LIST_KEYWORD", "FKCO_V_LIST_ADD_INFO", "FKCO_V_STATUS_NAME", "FKCO_V_STATUS_BEHAVIOR",
    "FKCO_MESSAGES_1", "FKCO_I_BLOCKINGHITS" })
