...
public class MessageFieldExtractor {
  ...
  public static MessageNameAddressResult extractNameAddress(
    ...
    if (fieldValues.size() == 2) {
      ...
      String fieldValue = CommonUtils.processMessage(fieldValues.get(0).get(0));
  ...
  static MessageNameAddressResult extractNameAddressHelper(
    ...
    String processedMessage = CommonUtils.processMessage(tag);
