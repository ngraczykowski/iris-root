...
import static com.google.protobuf.Empty.*;
...
class ProtoMessageConverterTest {
  ...
  private MessageRegistry messageRegistry = new MessageRegistry() {
    @Override
    public Optional<Parser<com.google.protobuf.Message>> findParser(
        String typeName) {
      if ("google.protobuf.Empty".equals(typeName)) {
        return Optional.of(new AbstractParser<com.google.protobuf.Message>() {
          @SneakyThrows
          @Override
          public com.google.protobuf.Message parsePartialFrom(
              CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws
              InvalidProtocolBufferException {
            return Empty.parseFrom(input);
          }
        });
      }
  ...
  class ToMessageTest {
    ...
    void doesNotWrapMessageWithAny() throws InvalidProtocolBufferException {
      ...
      assertThat(parseFrom(body)).isEqualTo(dummyMessage);
    }
  ...
  class FromMessageTest {
    ...
    void setUp() {
      ...
      anyMessage = toMessage(Any.pack(emptyMessage()));
    }
