...
public class CountryCTRPScreeningEntities   {
  ...
  public CountryCTRPScreeningEntities caseId(Integer caseId) {
    this.caseId = caseId;
    return this;
  }
  ...
  public CountryCTRPScreeningEntities recordId(BigDecimal recordId) {
  ...
  public CountryCTRPScreeningEntities inputStream(String inputStream) {
  ...
  public CountryCTRPScreeningEntities countryCode(String countryCode) {
  ...
  public CountryCTRPScreeningEntities typeOfMatch(String typeOfMatch) {
  ...
  public CountryCTRPScreeningEntities countryName(String countryName) {
  ...
  public CountryCTRPScreeningEntities matchType(String matchType) {
  ...
  public CountryCTRPScreeningEntities oWSWatchlistName(String oWSWatchlistName) {
    this.oWSWatchlistName = oWSWatchlistName;
    return this;
  }

  /**
   * This is the specific type of match that has ben identified, it is a sub-type of PRB List Type. Currently for Entities this will always be ESSC.
  ...
  public CountryCTRPScreeningEntities pRBListType(String pRBListType) {
  ...
  public CountryCTRPScreeningEntities cTRPValue(String cTRPValue) {
  ...
  public CountryCTRPScreeningEntities cTRPLevel(Integer cTRPLevel) {
  ...
  public CountryCTRPScreeningEntities cTRPCommonality(Integer cTRPCommonality) {
  ...
  public CountryCTRPScreeningEntities cTRPSource(Integer cTRPSource) {
  ...
  public CountryCTRPScreeningEntities cTRPNameType(String cTRPNameType) {
  ...
  public CountryCTRPScreeningEntities cTRPRuleNarrative(String cTRPRuleNarrative) {
  ...
  public CountryCTRPScreeningEntities alertKeyFragment(String alertKeyFragment) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.caseId, countryCTRPScreeningEntities.caseId) &&
        Objects.equals(this.recordId, countryCTRPScreeningEntities.recordId) &&
        Objects.equals(this.inputStream, countryCTRPScreeningEntities.inputStream) &&
        Objects.equals(this.countryCode, countryCTRPScreeningEntities.countryCode) &&
        Objects.equals(this.typeOfMatch, countryCTRPScreeningEntities.typeOfMatch) &&
        Objects.equals(this.countryName, countryCTRPScreeningEntities.countryName) &&
        Objects.equals(this.matchType, countryCTRPScreeningEntities.matchType) &&
        Objects.equals(this.oWSWatchlistName, countryCTRPScreeningEntities.oWSWatchlistName) &&
        Objects.equals(this.pRBListType, countryCTRPScreeningEntities.pRBListType) &&
        Objects.equals(this.cTRPValue, countryCTRPScreeningEntities.cTRPValue) &&
        Objects.equals(this.cTRPLevel, countryCTRPScreeningEntities.cTRPLevel) &&
        Objects.equals(this.cTRPCommonality, countryCTRPScreeningEntities.cTRPCommonality) &&
        Objects.equals(this.cTRPSource, countryCTRPScreeningEntities.cTRPSource) &&
        Objects.equals(this.cTRPNameType, countryCTRPScreeningEntities.cTRPNameType) &&
        Objects.equals(this.cTRPRuleNarrative, countryCTRPScreeningEntities.cTRPRuleNarrative) &&
        Objects.equals(this.alertKeyFragment, countryCTRPScreeningEntities.alertKeyFragment);
  }
