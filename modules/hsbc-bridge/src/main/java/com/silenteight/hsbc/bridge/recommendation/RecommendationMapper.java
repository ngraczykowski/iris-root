...
class RecommendationMapper {
  ...
  RecommendationMapper(
    ...
    this.falsePositive = s8Values.getOrDefault(FALSE_POSITIVE, "False Positive");
    this.manualInvestigation = s8Values.getOrDefault(MANUAL_INVESTIGATION, "Manual Investigation");
    this.potentialTruePositive =
        s8Values.getOrDefault(POTENTIAL_TRUE_POSITIVE, "Potential True Positive");
  }
  ...
  private HsbcRecommendation toRecommendation(String recommendedAction, String extendedAttribute5) {
    ...
    } else if (manualInvestigation.equals(recommendedAction)) {
