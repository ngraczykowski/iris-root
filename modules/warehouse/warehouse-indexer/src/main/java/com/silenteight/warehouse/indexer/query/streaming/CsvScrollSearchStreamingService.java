...
import com.silenteight.warehouse.indexer.query.streaming.exception.ReportGenerationException;
...
class CsvScrollSearchStreamingService implements DataProvider {
