...
import com.silenteight.warehouse.indexer.IndexingProperties;
...
class IndexerListenerConfiguration {
  ...
  ProductionRequestCommandIntegrationFlowAdapter productionRequestCommandIntegrationFlowAdapter(
      IndexRequestCommandHandler indexRequestCommand, IndexingProperties indexingProperties) {

    String environmentPrefix = indexingProperties.getEnvironmentPrefix();
