...
class DeprecatedBillingReport extends BaseEntity implements IdentifiableEntity {
  ...
  static DeprecatedBillingReport of(DeprecatedReportDefinition reportType) {
    DeprecatedBillingReport rbsReport = new DeprecatedBillingReport();
