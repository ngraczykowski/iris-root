...
@Slf4j
public class DeprecatedBillingReportAsyncGenerationService {

  static final String PRODUCTION_ANALYSIS_NAME = "production";
  @NonNull
  private final DeprecatedBillingReportRepository repository;
  @NonNull
  private final DeprecatedBillingReportGenerationService reportGenerationService;
  ...
  private void doGenerateReport(long id) {
    DeprecatedBillingReport report = getReport(id);
    report.generating();
  ...
  private DeprecatedBillingReport getReport(long id) {
    try {
