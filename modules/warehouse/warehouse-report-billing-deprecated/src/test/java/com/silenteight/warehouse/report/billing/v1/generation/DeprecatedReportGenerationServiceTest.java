...
import static com.silenteight.warehouse.report.billing.v1.generation.DeprecatedBillingScorerFixtures.ACTION_PREFIX;
...
class DeprecatedReportGenerationServiceTest {
  ...
  private DeprecatedBillingReportGenerationService underTest;
  ...
  void setUp() {
    ...
    underTest = new DeprecatedBillingReportGenerationConfiguration()
        .deprecatedBillingReportGenerationService(
  ...
  private Row buildRow(
    ...
    Map<String, String> map = Map.of(
        ALERT_PREFIX + DeprecatedBillingScorerFixtures.BILLING_YEAR_FIELD, year,
        ALERT_PREFIX + DeprecatedBillingScorerFixtures.BILLING_MONTH_FIELD, month,
        ALERT_PREFIX + DeprecatedBillingScorerFixtures.RECOMMENDED_ACTION_PREFIX_FIELD, action);
