...
import static com.silenteight.warehouse.report.reasoning.domain.AiReasoningReportDefinition.toProductionReportsDefinitionDto;
import static org.springframework.http.ResponseEntity.ok;

@Slf4j
@RestController
@RequestMapping(ROOT)
class ListAiReasoningReportsRestController {
