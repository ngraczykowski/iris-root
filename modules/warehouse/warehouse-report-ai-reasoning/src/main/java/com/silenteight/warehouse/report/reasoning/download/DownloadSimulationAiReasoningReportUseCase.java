...
class DownloadSimulationAiReasoningReportUseCase {
  ...
  public DownloadAiReasoningReportDto activate(long id, String analysisId) {
    log.debug("Getting simulation AI Reasoning report, reportId={}", id);
  ...
  private String getFileName(String analysisId, AiReasoningReportDto dto) {
  ...
  private static ReportFileNameDto toReportFileNameDto(
      String analysisId, AiReasoningReportDto dto) {
