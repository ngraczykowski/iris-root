...
import com.silenteight.warehouse.report.metrics.v1.domain.DeprecatedMetricsReportDefinition;
...
@Import({
    DeprecatedCreateMetricsReportRestController.class,
    DeprecatedCreateMetricsReportControllerAdvice.class,
    DeprecatedCreateMetricsReportUseCase.class,
})
class DeprecatedCreateMetricsReportRestControllerTest extends BaseRestControllerTest {
  ...
  @MockBean
  private DeprecatedMetricsReportService service;
