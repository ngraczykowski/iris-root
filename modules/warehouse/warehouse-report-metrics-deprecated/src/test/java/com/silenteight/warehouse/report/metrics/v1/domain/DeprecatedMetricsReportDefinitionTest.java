...
class DeprecatedMetricsReportDefinitionTest {

  @ParameterizedTest
  @EnumSource(DeprecatedMetricsReportDefinition.class)
  void testProperTimeRange(DeprecatedMetricsReportDefinition definition) {
