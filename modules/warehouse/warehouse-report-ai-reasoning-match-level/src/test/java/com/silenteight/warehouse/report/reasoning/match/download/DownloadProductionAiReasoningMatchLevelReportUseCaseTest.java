...
class DownloadProductionAiReasoningMatchLevelReportUseCaseTest {
  ...
  private DownloadProductionAiReasoningMatchLevelReportUseCase underTest;

  @BeforeEach
  void setUp() {
    underTest = new DownloadAiReasoningMatchLevelReportConfiguration()
        .downloadProductionAiMatchLevelReportUseCase(
  ...
  void shouldReturnDownloadAiReasoningMatchLevelReportDto() {
    ...
    // when
    DownloadAiReasoningMatchLevelReportDto dto = underTest.activate(REPORT_ID);
