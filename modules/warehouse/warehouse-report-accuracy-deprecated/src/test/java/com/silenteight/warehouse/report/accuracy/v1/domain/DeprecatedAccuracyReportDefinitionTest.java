...
class DeprecatedAccuracyReportDefinitionTest {

  @ParameterizedTest
  @EnumSource(DeprecatedAccuracyReportDefinition.class)
  void testProperTimeRange(DeprecatedAccuracyReportDefinition definition) {
