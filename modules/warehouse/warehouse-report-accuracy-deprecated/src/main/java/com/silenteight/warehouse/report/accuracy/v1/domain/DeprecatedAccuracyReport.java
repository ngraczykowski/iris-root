...
import com.silenteight.warehouse.report.accuracy.v1.domain.exception.WrongReportStateException;
...
class DeprecatedAccuracyReport extends BaseEntity implements IdentifiableEntity {
  ...
  private DeprecatedAccuracyReportDefinition reportType;
  ...
  static DeprecatedAccuracyReport of(
      DeprecatedAccuracyReportDefinition definition,
      String analysisId) {

    DeprecatedAccuracyReport report = new DeprecatedAccuracyReport();
    report.state = NEW;
