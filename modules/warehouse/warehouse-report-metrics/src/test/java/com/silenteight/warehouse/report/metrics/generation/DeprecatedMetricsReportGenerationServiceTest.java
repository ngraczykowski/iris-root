...
import static com.silenteight.warehouse.report.metrics.DeprecatedMetricsReportTestFixtures.DATE;
...
class DeprecatedMetricsReportGenerationServiceTest {

  @Mock
  private GroupingQueryService groupingQueryService;
  private DeprecatedMetricsReportGenerationService underTest;

  @BeforeEach
  void setUp() {
    underTest = new DeprecatedMetricsReportGenerationService(groupingQueryService);
  }
