...
import static com.silenteight.warehouse.report.metrics.DeprecatedMetricsReportTestFixtures.*;
...
@Import({
    DeprecatedDownloadMetricsReportRestController.class,
    DeprecatedDownloadMetricsReportConfiguration.class,
    GenericExceptionControllerAdvice.class
})
class DeprecatedDownloadMetricsReportRestControllerTest extends BaseRestControllerTest {
  ...
  private static final String DOWNLOAD_PRODUCTION_REPORT_URL =
      fromUriString("/v1/analysis/production/definitions/METRICS/"
          + "{definitionId}/reports/{id}")
          .build(of("definitionId", DAY_DEFINITION_ID, "id", REPORT_ID))
          .toString();

  @MockBean
  DeprecatedMetricsReportDataQuery query;
  @MockBean
  DeprecatedMetricsReportService reportService;
