...
import com.silenteight.warehouse.report.reasoning.v1.domain.exception.WrongReportStateException;
...
import static com.silenteight.warehouse.report.reasoning.v1.domain.DeprecatedReportState.GENERATING;
...
class DeprecatedAiReasoningReport extends BaseEntity implements IdentifiableEntity {
  ...
  private DeprecatedAiReasoningReportDefinition reportType;
  ...
  static DeprecatedAiReasoningReport of(
      DeprecatedAiReasoningReportDefinition definition, String analysisId) {

    DeprecatedAiReasoningReport report = new DeprecatedAiReasoningReport();
    report.state = NEW;
