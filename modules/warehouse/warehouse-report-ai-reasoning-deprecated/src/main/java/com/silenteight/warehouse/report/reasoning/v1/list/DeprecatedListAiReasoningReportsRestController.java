...
import static com.silenteight.warehouse.report.reasoning.v1.domain.DeprecatedAiReasoningReportDefinition.toProductionReportsDefinitionDto;
import static org.springframework.http.ResponseEntity.ok;

@Slf4j
@RestController
@RequestMapping(ROOT)
class DeprecatedListAiReasoningReportsRestController {
  ...
  public ResponseEntity<List<ReportDefinitionDto>> getProductionReportDefinitions() {
    log.debug("Getting production AI Reasoning report definitions.");
