...
@Getter
public enum DeprecatedAiReasoningReportDefinition {
  ...
  public static List<ReportDefinitionDto> toProductionReportsDefinitionDto() {
    return stream(DeprecatedAiReasoningReportDefinition.values())
        .filter(DeprecatedAiReasoningReportDefinition::isProduction)
  ...
  public static List<ReportDefinitionDto> toSimulationReportsDefinitionDto(String analysisId) {
    return stream(DeprecatedAiReasoningReportDefinition.values())
        .filter(not(DeprecatedAiReasoningReportDefinition::isProduction))
        .map(reportDefinition -> reportDefinition.toReportDefinitionDto(analysisId))
        .collect(toList());
  }

  public static DeprecatedAiReasoningReportDefinition getReportType(String id) {
