...
@Import({
    DeprecatedCreateAiReasoningReportRestController.class,
    DeprecatedCreateAiReasoningReportControllerAdvice.class,
    DeprecatedCreateProductionAiReasoningReportUseCase.class
})
class DeprecatedCreateAiReasoningReportRestControllerTest extends BaseRestControllerTest {
  ...
  @MockBean
  private DeprecatedCreateProductionAiReasoningReportUseCase productionUseCase;
  @MockBean
  private DeprecatedCreateSimulationAiReasoningReportUseCase simulationUseCase;
