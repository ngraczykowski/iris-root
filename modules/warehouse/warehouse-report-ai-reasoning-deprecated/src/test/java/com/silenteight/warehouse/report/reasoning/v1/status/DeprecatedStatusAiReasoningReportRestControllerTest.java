...
@Import({
    DeprecatedStatusAiReasoningReportRestController.class,
    GenericExceptionControllerAdvice.class
})
class DeprecatedStatusAiReasoningReportRestControllerTest extends BaseRestControllerTest {
  ...
  @MockBean
  private DeprecatedAiReasoningReportStatusQuery reportStatusQuery;
