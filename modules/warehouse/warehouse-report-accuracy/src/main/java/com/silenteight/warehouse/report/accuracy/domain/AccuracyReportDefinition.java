...
@Getter
public enum AccuracyReportDefinition {
  ...
  public static List<ReportDefinitionDto> toProductionReportsDefinitionDto() {
    return stream(AccuracyReportDefinition.values())
        .filter(AccuracyReportDefinition::isProduction)
  ...
  public static List<ReportDefinitionDto> toSimulationReportsDefinitionDto(String analysisId) {
    return stream(AccuracyReportDefinition.values())
        .filter(not(AccuracyReportDefinition::isProduction))
        .map(reportDefinition -> reportDefinition.toReportDefinitionDto(analysisId))
        .collect(toList());
  }

  public static AccuracyReportDefinition getReportType(String id) {
