...
@Import({
    StatusAccuracyReportRestController.class,
    GenericExceptionControllerAdvice.class
})
class StatusAccuracyReportRestControllerTest extends BaseRestControllerTest {
  ...
  @MockBean
  private AccuracyReportStatusQuery reportStatusQuery;
