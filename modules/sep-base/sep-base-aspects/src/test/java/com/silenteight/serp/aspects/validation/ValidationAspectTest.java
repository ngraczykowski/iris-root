...
import com.silenteight.serp.aspects.validation.business.BusinessService;
import com.silenteight.serp.aspects.validation.business.model.BusinessObject;
import com.silenteight.serp.aspects.validation.business.model.BusinessRequest;
...
class ValidationAspectTest {
  ...
  void validatesWhenCallMethodWithValidatedParameters() {
    assertThat(testService.performLogic(
