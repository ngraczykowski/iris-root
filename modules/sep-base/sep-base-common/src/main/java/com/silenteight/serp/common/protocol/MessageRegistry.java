...
import static com.silenteight.serp.common.protocol.AnyUtils.maybeUnpack;
import static com.silenteight.serp.common.util.ReflectionUtils.invokeStaticGetter;
...
public class MessageRegistry {
  ...
  public Optional<Message> maybeUnpackAny(Any any) {
    ...
    return findMessageType(typeName)
        .flatMap(messageType -> maybeUnpack(any, (Class<Message>) messageType.getType()));
  }
