...
import { HttpInternalServerErrorInterceptor } from '@app/shared/http/http-internal-sever-error.interceptor';
...
export const httpInterceptorProviders = [
  ...
  {provide: HTTP_INTERCEPTORS, useClass: HttpInternalServerErrorInterceptor, multi: true},
