...
import com.silenteight.sens.webapp.user.UserMappingFinder.InvalidMappingResultCountException;
...
public class UserMappingFinderTest {
  ...
  public void setUp() {
    ...
    when(userRepository.findByUserId(any())).thenReturn(USERS_COLLECTION.stream());
  }
