...
public class UserServiceTest {
  ...
  public void setUp() {
    ...
    classUnderTest = new UserService(userRepository, passwordEncoder, auditReaderProvider);
  }
  ...
  public void forExistingUserNameShouldThrowsUserAlreadyExistException() {
    ...
    when(userRepository.findOneByDeletedAtIsNullAndUserName(CREATED_USER_1_NAME))
  ...
  public void forExistingUserShouldUpdateGivenFields() {
    ...
    when(userRepository.getById(DUMMY_USER_ID)).thenReturn(user);
  ...
  public void findAllById() {
    //given
    final User user = createUser(CREATED_USER_1_NAME, CREATED_USER_1_PASS);
    when(userRepository.findById(singletonList(user.getId()))).thenReturn(of(user));
