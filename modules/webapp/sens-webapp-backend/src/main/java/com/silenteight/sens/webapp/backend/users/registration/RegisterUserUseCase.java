...
import com.silenteight.sens.webapp.backend.users.registration.domain.CompletedUserRegistration.NewUserCredentials;
import com.silenteight.sens.webapp.backend.users.registration.domain.CompletedUserRegistration.NewUserDetails;
import com.silenteight.sens.webapp.backend.users.registration.domain.NewUserRegistration;
