...
public class ChangeRequestNotAllowedForMakerException extends RuntimeException implements Serializable {

  private static final long serialVersionUID = 4355597242383617206L;

  public ChangeRequestNotAllowedForMakerException(long changeRequestId) {
