...
class UpdateUserDisplayNameUseCaseTest {
  ...
  @BeforeEach
  void setUp() {
    UserUpdateUseCaseConfiguration configuration =
        new UserUpdateUseCaseConfiguration();

    underTest = configuration.updateUserDisplayNameUseCase(updatedUserRepository);
  }
