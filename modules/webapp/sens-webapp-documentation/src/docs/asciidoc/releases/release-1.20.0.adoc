...
|Business Operator can download a CSV report from the Web App presenting the list of reasoning branches.
|{issue_url}WA-619[WA-619]
|Business Operator can cancel any Pending Change Request.
