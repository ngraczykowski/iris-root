...
public class SensWebAppApplicationBuilder {
  ...
  public SensWebAppApplicationBuilder springCloud(boolean enabled) {
    bootstrapProperties(
        "spring.cloud.bootstrap.enabled=" + Boolean.toString(enabled),
        "spring.cloud.config.enabled=" + Boolean.toString(enabled));
    return this;
  }
  ...
  public SensWebAppApplicationBuilder web(boolean web) {
    this.web = web;
    return this;
  }
  ...
  private void applyBasicProperties(SpringApplicationBuilder builder) {
    ...
    if (web != null)
      builder.web(getWebApplicationType());
  }

  private WebApplicationType getWebApplicationType() {
    return web ? SERVLET : NONE;
  }
