...
<#function comment alertModel matchModel featureModel>
    ...
    <#return "Alerted party account (${alertedPartyId}) and watchlist id (${watchlistPartyId}) was previously evaluated as False Positive (${truePositiveCount}/${falsePositiveCount}).">
</#function>
