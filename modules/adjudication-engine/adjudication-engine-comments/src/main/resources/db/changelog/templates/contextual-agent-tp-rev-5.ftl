...
<#assign mappings={
"TRUE_POSITIVE": "Potential True Positive",
...
<#function comment alertModel matchModel featureModel>
    ...
    <#return "Alerted context (${alertedPartyId}) and watchlist id (${watchlistPartyId}) was previously evaluated as ${mappings[solution]} (${truePositiveCount}/${falsePositiveCount}).">
</#function>
