...
<#function comment alertModel matchModel featureModel>
    ...
    <#return "Alerted paaaarty account (${alertedPartyId}) and watchlist id (${watchlistPartyId}) was previously evaluated as Potential True Positive (${truePositiveCount}/${falsePositiveCount}).">
</#function>
