INSERT INTO ae_comment_template (template_name, created_at, revision, template) VALUES ('historical-agent-fp.ftl', now(), 2, '<#import "match-utils.ftl" as matchUtils>
...
<#function comment alertModel matchModel featureModel>
    ...
    <#return "Historical Risk Account Number False Positive agent is a ${solution} [FP count(${falsePositiveCount}), TP cont(${truePositiveCount})].">
</#function>
')
