...
'COUNTRY_WEAK_MATCH': 'does not match'
}>
...
<#function isSolutionConsistent alertModel matchModel featureModel>
    <#if matchModel.solution?matches('.*FALSE_POSITIVE') && ['COUNTRY_NO_MATCH', 'STATE_NO_MATCH', 'CITY_NO_MATCH', 'COUNTRY_WEAK_MATCH']?seq_contains(featureModel.solution)>
        <#return true>
