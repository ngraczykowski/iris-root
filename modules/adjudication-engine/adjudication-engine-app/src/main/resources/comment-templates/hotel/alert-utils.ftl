...
<#function getDecisionGroupOutput alertModel decision matches >
    ...
    <#list matches as match>
        <#if alertModel.commentInput?has_content>
            <#if alertModel.commentInput.listName?has_content>
                <#local listName = alertModel.commentInput.listName>
                <#local wlId = alertModel.commentInput.wlId>
                <#local wlType = alertModel.commentInput.wlType>
                <#assign solution = match.solution>
                <#if solution! == decision>

                    <#if wlType! == "SSC">
                            <#assign output = 'Alert was generated on the watchlist location.'>
                    <#else>
