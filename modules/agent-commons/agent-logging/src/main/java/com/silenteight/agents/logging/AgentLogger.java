...
public class AgentLogger {
  ...
  /**
   * <p>Logs exception and its stacktrace</p>
   * <p>Intended use: unrecoverable errors</p>
   */
  public static void error(Logger log, String message, Throwable error) {
   ...
   *
   * @param parameters
   *     Parameters values that does not need any computing to transform to String value
   */
  public static void warn(Logger log, String message, Object... parameters) {
    if (log.isWarnEnabled()) {
   ...
   *     Parameters values that does not need any computing to transform to String value
   */
  public static void info(Logger log, String message, Object... parameters) {
   ...
   *     Parameters values that does not need any computing to transform to String value
   */
  public static void debug(Logger log, String message, Object... parameters) {
   ...
   *     Parameters values that does not need any computing to transform to String value
   */
  public static void trace(Logger log, String message, Object... parameters) {
