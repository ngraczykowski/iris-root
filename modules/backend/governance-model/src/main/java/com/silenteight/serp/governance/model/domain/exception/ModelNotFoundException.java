...
public class ModelNotFoundException extends RuntimeException {
  ...
  public ModelNotFoundException(@NonNull UUID modelId) {
    super(format("Model with modelId=%s not found.", modelId));
  }

  public ModelNotFoundException(@NonNull String modelVersion) {
    super(format("Model with modelVersion=%s not found.", modelVersion));
  }
}
