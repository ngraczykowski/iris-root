...
@Slf4j
@ControllerAdvice
class EditPolicyControllerAdvice {

  @ExceptionHandler(WrongPolicyStateChangeException.class)
  public ResponseEntity<String> handle(WrongPolicyStateChangeException e) {
    log(e);
