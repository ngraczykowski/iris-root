...
interface DecisionRepository extends Repository<Decision, Long> {
  ...
  AlertAnalysisDetailsDto findAnalysisDetails(String alertName, Integer level);
  ...
  @Query(value = FIND_DETAILS_QUERY_VALUE)
  AlertValidationDetailsDto findValidationDetails(String alertName, Integer level);
