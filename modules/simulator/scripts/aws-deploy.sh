...
export CHART_NAME=simulator-app
...
skopeo copy docker://docker.repo.silenteight.com/simulator/$CHART_NAME:$INSTALLER_VERSION docker://$IMAGE_REPO:$INSTALLER_VERSION
skopeo copy docker://docker.repo.silenteight.com/simulator/$CHART_NAME:$INSTALLER_VERSION docker://$IMAGE_REPO:latest
