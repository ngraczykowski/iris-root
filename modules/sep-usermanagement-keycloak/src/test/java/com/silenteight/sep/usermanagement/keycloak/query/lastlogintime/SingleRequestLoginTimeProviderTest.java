...
import static com.silenteight.sep.usermanagement.keycloak.query.lastlogintime.SingleRequestLoginTimeProviderTest.SingleRequestLoginTimeProviderFixtures.EARLIER_EVENT;
import static com.silenteight.sep.usermanagement.keycloak.query.lastlogintime.SingleRequestLoginTimeProviderTest.SingleRequestLoginTimeProviderFixtures.LATER_EVENT;
import static com.silenteight.sep.usermanagement.keycloak.query.lastlogintime.SingleRequestLoginTimeProviderTest.SingleRequestLoginTimeProviderFixtures.USER_ID;
...
class SingleRequestLoginTimeProviderTest {
  ...
  void returnsCorrectTime_whenOnlyOneEvent() {
    givenUserLoginEvents(List.of(EARLIER_EVENT));
  ...
  static class SingleRequestLoginTimeProviderFixtures {
    ...
    static final KeycloakLoginEvent EARLIER_EVENT =
        KeycloakLoginEvent.builder().time("2020-02-02T10:10:10Z").build();

    static final KeycloakLoginEvent LATER_EVENT =
        KeycloakLoginEvent.builder().time("2020-02-01T10:10:10Z").build();
  }
}
