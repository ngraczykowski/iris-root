...
import static com.silenteight.sep.usermanagement.keycloak.query.lastlogintime.LastLoginTimeCacheUpdaterTest.LastLoginTimeCacheUpdaterFixtures.CACHE_SIZE;
import static com.silenteight.sep.usermanagement.keycloak.query.lastlogintime.LastLoginTimeCacheUpdaterTest.LastLoginTimeCacheUpdaterFixtures.FETCHED_LOGIN_TIMES;
...
class LastLoginTimeCacheUpdaterTest {
  ...
  void updatesCorrectly() {
    given(lastLoginTimeBulkFetcher.fetch(CACHE_SIZE)).willReturn(
        FETCHED_LOGIN_TIMES);
