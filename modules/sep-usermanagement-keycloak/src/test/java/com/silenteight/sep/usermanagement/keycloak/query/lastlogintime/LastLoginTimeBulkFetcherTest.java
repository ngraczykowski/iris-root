...
import static com.silenteight.sep.usermanagement.keycloak.query.lastlogintime.LastLoginTimeBulkFetcherTest.LastLoginTimeBulkFetcherFixtures.*;
...
class LastLoginTimeBulkFetcherTest {
  ...
  private void givenEvents(List<KeycloakLoginEvent> events) {
    ...
    given(realmResource.getEvents(
        List.of(KeycloakLastLoginTimeConfiguration.LOGIN_EVENT_TYPE),
