...
@Component("registrationAmqpErrorHandler")
class RegistrationAmqpErrorHandler implements RabbitListenerErrorHandler {

  private final AmqpRegistrationProperties amqpRegistrationProperties;
  ...
  public Object handleError(
    ...
    getMessageDeathCount(amqpMessage).ifPresentOrElse(
        value -> {
          var numberOfRetries = amqpRegistrationProperties.numberOfRetriesDeadMessages();
