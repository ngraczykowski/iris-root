...
@Component("reportsAmqpErrorHandler")
class ReportsAmqpErrorHandler implements RabbitListenerErrorHandler {

  private final AmqpReportsProperties amqpRecommendationProperties;
