...
class ReportFixtures {
  ...
  static def ALERT_ONE_WITHOUT_MATCHES = AlertWithoutMatchesDto.builder()
      ...
      .alertStatus(ALERT_ONE_STATUS)
      .metadata(ALERT_ONE_METADATA)
      .errorDescription(ALERT_ONE_ERR_DESC)
      .build()

  static def ALERT_TWO_WITHOUT_MATCHES = AlertWithoutMatchesDto.builder()
      .id("2")
  ...
  static def MATCH_TWO_WITH_ALERT_ID = MatchWithAlertId.builder()
      .alertId("2")
      .id(MATCH_TWO_ID)
      .name(MATCH_TWO_NAME)
      .build()
  ...
  static def ERROR_REPORT_TWO = Report.builder()
      .batchId(BATCH_ID)
      .analysisName('')
      .alertData(
          ALERT_DATA_ONE.toBuilder()
