...
{{/*
Create the HTTP context path to use
*/}}
{{- define "spring.webPath" -}}
{{- default (include "spring.fullname" .) .Values.spring.webPath }}
{{- end }}
