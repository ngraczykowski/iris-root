...
public class RabbitCommonSchemaConfiguration {
  ...
  private static final Declarable[] COMMON_SCHEMA = {
      ...
      directExchange(BRIDGE_LEARNING_ENGINE_EXCHANGE).durable(true).build(),
      topicExchange(CONNECTOR_EVENT_EXCHANGE).durable(true).build(),
      directExchange(CONNECTOR_COMMAND_EXCHANGE).durable(true).build(),
