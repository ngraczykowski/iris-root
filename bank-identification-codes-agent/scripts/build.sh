...
pip install shiv
shiv -e bank_identification_codes.__main__:main "$@" --compressed -o "./dist/bank_identification_codes-$version.pyz" "dist/$artifact"

# configuration example
example_config_path="./config"
example_config="bank_identification_codes_config-${version}.tgz"
