...
from etl_pipeline.xml_spark.xml_pipeline import AlertHitDictFactory, WatchlistExtractor
from tests.shared import TEST_ETL_PIPELINE_DATA_PATH, TEST_SHARED_DATA_REFERENCE_DIR
from tests.test_spark.test_unit.test_spark_xml.test_etl_pipeline.reference.test_get_wl_hit_aliases_matched_name import (
    INPUT_WHITELIST,
