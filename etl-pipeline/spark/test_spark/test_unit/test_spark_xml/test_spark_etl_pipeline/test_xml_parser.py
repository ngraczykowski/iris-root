...
import pytest
from spark_etl_pipeline.custom.aia.config import AIA_ALERT_HEADER_CONFIG, AIA_HIT_CONFIG
from spark_etl_pipeline.custom.aia.xml_pipeline import AIAWatchlistExtractor, AIAXMLPipeline
from spark_etl_pipeline.data_processor_engine.spark_engine import SparkProcessingEngine
from spark_etl_pipeline.xml_spark.xml_pipeline import AlertHitDictFactory, WatchlistExtractor
from test_spark.shared import TEST_ETL_PIPELINE_DATA_PATH, TEST_SHARED_DATA_REFERENCE_DIR
from test_spark.test_unit.test_spark_xml.test_spark_etl_pipeline.reference.test_get_wl_hit_aliases_matched_name import (
    INPUT_WHITELIST,
    REFERENCE_OUTPUT_FOR_TEST_WL_HIT_ALIASES_MATCHED_NAME,
)
from test_spark.utils import compare_dataframe, load_json, load_pickle, load_xml
