from etl_pipeline.xml_parser.xml_extractor import XMLFunction
from etl_pipeline.xml_spark.config import XMLExtractorConfig

RAW_DATA_DIR = "tests/shared/reference/1.raw"
